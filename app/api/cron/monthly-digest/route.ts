...
export async function GET(req: NextRequest) {
  ...
  // Run on May 29 2026 (manual kickoff), then 2nd Wednesday of each month (day 8–14, must be Wednesday)
  const today = new Date()
  const isKickoff = today.getUTCFullYear() === 2026 && today.getUTCMonth() === 4 && today.getUTCDate() === 29
